<template>
  <div>
    ...
    <!-- 主体内容 START -->
    <div id="container" class="m-container-small m-padding-large-responsive">
      <div class="ui container">
        <!-- header START -->
        <div class="ui top attached segment">
          <div class="ui horizontal link list m-blog-info">
            <div class="item">
              <img
              ...
              />
              <div class="content">
                <a href="#" target="_blank" class="header">Sanna</a>
              </div>
            </div>
            <div class="item">
        ...
        <!-- image END -->
        <!-- content START -->
        <div id="blog" class="ui attached segment">
          ...
          >
            ...
            <p class="typo-first">
              ...
              Yahoo、Eric Meyer 和 Alice base.css 中采用的 Reset
              都没有很好地考虑中文排版。<i class="serif">Typo.css</i>
              要做的就是解决中文排版的问题。
            </p>
            ...
            <p>
              在中文排版中，HTML4
              的很多标准在语义在都有照顾到。但从视觉效果上，却很难利用单独的 CSS
              来实现，像<abbr title="在文字下多加一个点">着重号</abbr
              >（例：这里<em class="typo-em">强调一下</em>）。在 HTML4
              中，专名号标签（<code>&lt;u&gt;</code>）已经被放弃，而 HTML5 被<a
            ...
            <p>
              对于这些，<i class="serif">Typo.css</i>
              排版项目的中文偏重注意点，都添加在附录中，详见：
            </p>
            <blockquote>
              <b>附录一</b>：<a href="#appendix1"
                ><i class="serif">Typo.css</i> 排版偏重点</a
              >
            </blockquote>
            ...
            <p>
              目前已有像百姓网等全面使用
              <i class="serif">Typo.css</i>
              的项目，测试平台的覆盖，特别是在<abbr
                title="手机、平板电脑等移动平台"
                >移动端</abbr
              >上还没有覆盖完主流平台，希望有能力的同学能加入测试行列，或者加入到
              <i class="serif">Typo.css</i> 的开发。加入方法：
              <a href="https://github.com/sofish/Typo.css"
                >参与 <i class="serif">Typo.css</i> 开发</a
              >。如有批评、建议和意见，也随时欢迎给在 Github 直接提
              <a href="https://github.com/sofish/Typo.css/issues">issues</a
              >，或给<abbr title="Sofish Lin, author of Typo.css" role="author"
                >我</abbr
              >发 <a href="mailto:sofish@icloud.com">邮件</a>。
            </p>

            <h2 id="section2">二、排版实例：</h2>

            <p>
              提供2个排版实例，第一个中文实例来自于来自于<cite
                class="typo-unique"
                >张燕婴</cite
            ...
            <ul>
              <li>
                ...
                friend, experience as your reference, prudence as your brother
            ...
            <h4>
              You may want to create a perfect <code>&lt;hr /&gt;</code> line,
              despite the fact that there will never have one
            </h4>
            <hr />
            <p>
              ...
              <mark
                ...
                want of will, rather than of means, that man fails to succeed".
              </mark>
              You just need to follow the browser's behavior, and set a right
              <code>margin</code> to it。it will works nice as the demo you're
              watching now. The following code is the best way to render typo in
              Chinese:
            </p>
            <pre>
...
.typo p, .typo pre, .typo ul, .typo ol, .typo dl, .typo form, .typo hr {
    margin:1em 0 0.6em;
            ...
            <table summary="Typo.css 排版偏重点" class="ui table">
              <thead>
                <tr>
                  <th>类型</th>
                  <th>语义</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    在全局没有 <code>list-style</code>，在 .<code>typo</code>
                    中对齐正确
                  </td>
                </tr>
                <tr>
                  ...
                  <td><code>dl</code></td>
                  <td>
                    全局 <code>padding</code> 和 <code>margin</code>为0， .<code
                      >typo</code
                    >
                    中对齐正确
                  </td>
                ...
                <tr>
                  ...
                  <td><code>em</code></td>
                  <td>
                    在全局显示正体，在 <code>.typo</code> 中显示与
                    <code>b</code> 和 <code>strong</code> 的样式一致，为粗体
                  </td>
                </tr>
                <tr>
                  <td>加强</td>
                ...
                <tr>
                  ...
                  <td>
                    字体使用 <code>courier</code> 系字体，保持与
                ...
                <tr>
                  ...
                  <td>
                    由于 <code>u</code> 被 HTML4 放弃，在向后兼容上推荐使用
                    <code>.typo-u</code>
                  </td>
                </tr>
                <tr>
          ...
          <div id="payCode" class="ui flowing popup transition hidden">
            <div class="ui orange basic label">
              <div class="ui images" style="font-size: 1rem; font-weight: 400">
                <div class="image">
                  <img
                    src="@/assets/upload/tenpay.jpg"
                    alt=""
                    class="ui rounded bordered image m-code-img"
                  />
                  <div>微信</div>
                </div>
                <div class="image">
                  <img
                    src="@/assets/upload/alipay.jpg"
                    alt=""
                    class="ui rounded bordered image m-code-img"
                  />
                  <div>支付宝</div>
          ...
          <div class="ui middle aligned grid">
            <div class="eleven wide column">
              <ui class="ui list" style="line-height: 2">
                ...
                <li>公众号转载：请在文末添加作者个人博客二维码</li>
              </ui>
            </div>
            <div class="five wide column">
              <img
                src="@/assets/upload/QQ.jpg"
                alt=""
                class="ui right floated rounded bordered image m-code-img"
              />
            </div>
          </div>
        </div>
...
// 代码高亮
import "@/assets/lib/prismjs/prism.js";
import "@/assets/lib/prismjs/prism.css";
// 赞赏弹窗
